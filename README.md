...
- Der Kartenwechsel am Gerät (Action 6/2) **bricht einen laufenden Auftrag ab**. Wählt man die Etage, während der Roboter arbeitet, folgt deshalb nur die Anzeige (Dropdown, Auswahlschalter, Flags); das Gerät wird erst beim nächsten Start umgeschaltet. In *Letzter Fehler* und im Meldungs-Log steht ein Hinweis darauf.
